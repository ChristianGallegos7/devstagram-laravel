        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('registro.store')}}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    >
                    @error('name')
                        <p class="bg-red-500 p-4 rounded-lg text-white my-2">{{$message}}</p>
                    @enderror
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation"
                        placeholder="Repetir Password..."  class="border p-3 w-full rounded-lg @error('password_confirmation')
                            border-red-500
                        @enderror">
                </div>
